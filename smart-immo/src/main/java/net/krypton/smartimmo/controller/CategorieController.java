...
public class CategorieController {
	...
	public String enregistrerCategorie(@Valid Categorie a,
	...
	public String modifierCategorie(@Valid Categorie a, BindingResult result,
			ModelMap model, @PathVariable int idCategorie) {
