	...
	<!-- start: Content -->
			...
			<div class="row-fluid">
				...
				<div class="span3 statbox purple" onTablet="span6" onDesktop="span3">
					<div class="boxchart" style="width:120px; height:100;">5,6,7,2,3,4,3,4,8,5,3,3,7</div>
					<div class="number">854<i class="icon-arrow-up"></i></div>
					<div class="title">Fournisseurs</div>
					<!--<div class="footer">
						<a href="#"> biens publiés</a>
					</div>-->	
				</div>
				
				<div class="span2 statbox green" onTablet="span6" onDesktop="span3">
					<div class="boxchart">5,2,1,4,3,3,2,3</div>
				...
				<div class="span2 statbox blue noMargin" onTablet="span6" onDesktop="span3">
					<div class="boxchart">5,4,2,6,4,3,4,3,3</div>
				...
				<div class="span2 statbox yellow" onTablet="span6" onDesktop="span3">
					<div class="boxchart">6,5,2,7,4,3,4,3,3</div>
					<div class="number">678<i class="icon-arrow-down"></i></div>
					<div class="title">Visiteurs</div>
					<!--
					<div class="footer">
						<a href="#"> read full report</a>
					</div>
				...
				<div class="span3 statbox red" onTablet="span6" onDesktop="span3">
					<div class="boxchart">5,4,7,4,8,7,5,6,4,4,3,3,5</div>
					<div class="number">854<i class="icon-arrow-up"></i></div>
				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<div class="content">
						...
						<div class="browserStat big">
							<img src="smartImmo-admin/img/browser-chrome-big.png" alt="Chrome">
							<span>34%</span>
						</div>
						<div class="browserStat big">
							<img src="smartImmo-admin/img/browser-firefox-big.png" alt="Firefox">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="smartImmo-admin/img/browser-ie.png" alt="Internet Explorer">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="smartImmo-admin/img/browser-safari.png" alt="Safari">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="smartImmo-admin/img/browser-opera.png" alt="Opera">
							<span>34%</span>
						</div>	
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
								<a href="#">
									<img class="avatar" alt="Dennis Ji" src="smartImmo-admin/img/avatar.jpg">
								</a>
