...
<div class="generic-container">
	<div class="container">
		...
		<f:form method="POST" modelAttribute="formFournisseur"
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="mdpFournisseur">Mot
						de Passe</label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="telFixeFournisseur">Téléphone
						Fixe</label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="telMobileFournisseur">Téléphone
						Mobile</label>
					<div class="col-md-7">
